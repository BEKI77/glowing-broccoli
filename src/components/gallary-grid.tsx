  ...
  "Dinning Table": (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M3 3h18v18H3V3zm0 6h18M9 3v18"
      />
    </svg>
  ),
  Cabinets: (
          ...
          >
            <div className="relative aspect-square overflow-hidden rounded-xl bg-slate-50 dark:bg-slate-800 shadow-sm hover:shadow-lg transition-all duration-400 border border-slate-200 dark:border-slate-700">
              <img
                src={
                  url ||
                  "/placeholder.svg?height=400&width=400&query=modern+furniture"
                }
  ...
  return (
    <div className="min-h-screen ">
      ...
      <img
        ...
        className="object-cover opacity-45 max-h-[100vh] absolute w-full "
      />
      <div className="absolute inset-0 bg-gradient-to-b from-background/5 via-background/60 to-background h-[100%]" />

      <div className="relative overflow-hidden -my-20 pt-20">
        <div className="px-6 py-24 text-center ">
          ...
          <motion.p
            ...
            className="text-md md:text-lg max-w-2xl mx-auto leading-relaxed font-light mb-20"
          >
            Explore our carefully curated collection of contemporary furniture
            designed for sophisticated living spaces
          </motion.p>
        </div>
      </div>

      <div className="relative flex flex-col gap-6 bg-gradient-to-b from-background/5 via-background/60 to-background ">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3 mb-6">
              {categories.map((category) => (
                ...
                >
                  {/* Selection indicator */}
                  <div
                    className={`absolute -top-1 -right-1 w-5 h-5 rounded-full border-2  transition-all duration-200 ${
                      selectedCategories.includes(category.name)
            ...
            {selectedCategories.length > 0 && (
              <div className="text-center pt-4 border-t ">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-slate-700 hover:bg-slate-800 rounded-lg font-medium transition-all duration-200 hover:scale-105"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
