...
const contactFormSchema = z.object({
  ...
  phone: z
    ...
    .refine(
      (val) =>
        !val || /^[09]?[1-9][\d]{0,15}$/.test(val.replace(/[\s\-\\$]/g, "")),
      {
  ...
  return (
    <div className="min-h-screen">
      ...
      <img
        ...
        className="object-cover opacity-80 dark:opacity-40 absolute w-full"
      />
        ...
        <div className="relative z-10 min-h-screen flex items-center">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6 animate-slide-in-left flex flex-col items-start ">
                ...
                <p className="text-sm md:text-lg leading-relaxed max-w-lg text-left">
                  Ready to create something beautiful? We'd love to hear about
                  your project and discuss how we can bring your vision to life
                  with our handcrafted furniture.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link
                    to="https://t.me/gedi_k"
                    target="_blank"
      ...
      <section className="relative py-20  pb-64">
        <div className=" inset-0">
          <img
            src={Home_page["image6"]}
            alt="Workshop interior"
            className="object-cover opacity-80 dark:opacity-40 w-full absolute"
          />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 ">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-sm md:text-lg max-w-2xl mx-auto">
              Choose the best way to reach us. We're here to answer your
              questions and discuss your project.
            </p>
          </div>
                ...
                <CardContent className="p-6">
                  ...
                  {method.href ? (
                    <a href={method.href} className="w-full mt-4 block">
                      <Button className="w-full gallery-btn-primary">
                        {method.title.split(" ")[0]} Now
                      </Button>
                    </a>
                  ) : (
                    <Button className="w-full mt-4 gallery-btn-primary">
                      {method.title.split(" ")[0]} Now
                    </Button>
                  )}
                </CardContent>
      ...
      <section className="py-24 pt-60  -mt-60">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="animate-slide-in-left">
              <Card>
                <CardHeader>
                  <CardTitle className="text-3xl mb-2 flex items-center justify-center">
                    {submitSuccess ? (
                      <>
                  ...
                  {!submitSuccess ? (
                    <Form {...form}>
                      ...
                      >
                        ...
                        <Button
                          type="submit"
                          className="gallery-btn-primary w-full"
                          size="lg"
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-600 mb-6">
                        ...
                        hours. In the meantime, feel free to explore our gallery
                        or call us directly.
                      </p>
            ...
            <div className="space-y-8 animate-slide-in-right">
              ...
              <Card className="">
                ...
                <CardContent className="p-6">
                  ...
                  <Button className="w-full mt-6 gallery-btn-primary">
                    Get Directions
                  </Button>
                </CardContent>
              </Card>
                  ...
                  <div className="flex space-x-4">
                    <Link to="https://www.facebook.com/share/17DoMMDj6o/?mibextid=wwXIfr">
                      <Button
                        variant="outline"
                        size="icon"
                        className="social-btn facebook-btn bg-transparent"
                      >
                    ...
                    <Link to="https://www.instagram.com/mh_furniture_et?igsh=aDJ2OHZpN3ZpZ2pr">
                      <Button
                        variant="outline"
                        size="icon"
                        className="social-btn instagram-btn bg-transparent"
                      >
                    ...
                    <Link to="https://www.tiktok.com/@mh_furniture?_t=ZM-8yoxXQcDLA0&_r=1">
                      <Button
                        variant="outline"
                        size="icon"
                        className="social-btn twitter-btn bg-transparent"
                      >
      ...
      <section className="relative pb-14">
        <div className=" inset-0">
          <img
            ...
            alt="Workshop interior"
            className="object-cover opacity-80 dark:opacity-40 w-full absolute h-[100%]"
          />
        </div>
        <div className="absolute inset-0 bg-gradient-to-b from-background via-background/35 to-background" />
        <div className=" relative max-w-7xl mx-auto px-4 ">
