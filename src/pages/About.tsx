...
const values = [
  {
    ...
    description:
      "Every piece is created with love and dedication to the art of woodworking.",
    img: image_links["image4"],
  },
  {
    icon: Leaf,
    title: "Sustainable Materials",
    description:
      "We source only the finest, sustainably harvested wood for our furniture.",
    img: image_links["image5"],
  },
  {
    icon: Award,
    title: "Quality Guarantee",
    description: "Each piece comes with our lifetime craftsmanship guarantee.",
    img: image_links["image6"],
  },
  {
    icon: Users,
    title: "Family Tradition",
    description:
      "Three generations of furniture makers bringing you timeless designs.",
    img: image_links["image7"],
  },
];
...
const craftProcess = [
  {
    ...
    img: "/placeholder.svg?height=400&width=600&text=Wood+Selection+Process+Premium+Materials",
  },
  {
    step: "02",
    title: "Hand Crafting",
    ...
    img: "/placeholder.svg?height=400&width=600&text=Master+Craftsman+Hand+Shaping+Wood",
  },
  {
    step: "03",
    ...
    img: "/placeholder.svg?height=400&width=600&text=Furniture+Finishing+Process+Premium+Quality",
  },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cream-50 to-warm-50">
      ...
      <img
        ...
        className="object-cover opacity-90 dark:opacity-40 absolute"
      />
              ...
              <div className="space-y-5 flex flex-col items-start ">
                ...
                <div className="space-y-6 mt-2">
                  <motion.h1
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.4, duration: 0.5 }}
                    className="mx-auto max-w-2xl text-5xl lg:text-6xl font-bold leading-tight text-left"
                  >
                  ...
                  >
                    For over 20+ years, MH Furniture Shop has been creating
                    beautiful, handcrafted furniture that tells a story.Every
                    piece we create is a testament to our commitment to quality,
      ...
      <section className="py-20 -mt-20 relative min-h-screen overflow-hidden">
        ...
        <div className="mx-auto px-4 z-10 absolute h-full w-full">
          <div className="flex flex-col gap-10 h-full justify-center ">
            ...
            >
              Our{" "}
              <span className="text-amber-600 font-serif italic">Mission</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Our mission is to design, manufacture, and trade exceptional
              furniture that combines timeless craftsmanship with contemporary
              aesthetics, ensuring lasting value and customer satisfaction. We
              believe that furniture should be more than functional—it should be
              a work of art that lasts for generations, telling the story of the
              hands that crafted it and the home that embraces it.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-sm md:text-lg max-w-2xl mx-auto">
              The principles that guide everything we do, from selecting
              materials to delivering your finished piece
            </p>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-sm md:text-xl max-w-3xl mx-auto">
              Every piece goes through a meticulous process that combines
